...
def test_parser():
    ...
    test_data1 = """Login Issue | TK-001 | john.doe@example.com | Open | 2025-08-01 | 2025-08-04 | 2025-08-03 | High | Alice
Payment Failure | TK-002 | jane.smith@example.com | In Progress | 2025-07-29 | 2025-08-02 | 2025-08-01 | Medium | Bob"""
    ...
    test_data2 = "Login Issue\tTK-003\tjohn.doe@example.com\tOpen\t2025-08-01\t2025-08-04\t2025-08-03\tHigh\tAlice"
    ...
    test_data3 = "Login Issue | TK-004 | john.doe@example.com | Open"
